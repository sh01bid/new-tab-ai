...
export {}
declare global {
  const ChatWindow: typeof import('D:/dev/new-tab-ai/packages/extension/components/ChatWindow').ChatWindow
  const ContentScriptContext: typeof import('wxt/utils/content-script-context').ContentScriptContext
  const InvalidMatchPattern: typeof import('wxt/utils/match-patterns').InvalidMatchPattern
  const MatchPattern: typeof import('wxt/utils/match-patterns').MatchPattern
  const SearchBar: typeof import('D:/dev/new-tab-ai/packages/extension/components/SearchBar').SearchBar
  const ShortcutsGrid: typeof import('D:/dev/new-tab-ai/packages/extension/components/ShortcutsGrid').ShortcutsGrid
